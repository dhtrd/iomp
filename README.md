...
npm test        # ١٬٥٢٣ اختبارًا للتطبيق الحي (٥٥ ملفًا)
```
...
node run_all_tests.mjs       # ٤) يجب أن يُنهي بـ TOTAL: 1523/1523 — ALL GREEN ✓
```
لتشغيل الحزمة على ملفٍّ آخر: `SRC_HTML=index.source.html node run_all_tests.mjs`

## CI/CD
كل دفع إلى `main`: اختبارات التطبيق (١٬٥٢٣) + اختبارات القواعد بالمحاكي ← وعند الخضرة: نشر تلقائي إلى GitHub Pages.
