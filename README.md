...
npm test        # ١٬٤٨٥ اختبارًا للتطبيق الحي (٥٤ ملفًا)
```
...
node run_all_tests.mjs       # ٤) يجب أن يُنهي بـ TOTAL: 1485/1485 — ALL GREEN ✓
```
لتشغيل الحزمة على ملفٍّ آخر: `SRC_HTML=index.source.html node run_all_tests.mjs`

## CI/CD
كل دفع إلى `main`: اختبارات التطبيق (١٬٤٨٥) + اختبارات القواعد بالمحاكي ← وعند الخضرة: نشر تلقائي إلى GitHub Pages.
