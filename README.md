...
npm test        # ١٬٥٤٠ اختبارًا للتطبيق الحي (٥٥ ملفًا)
```
...
node run_all_tests.mjs       # ٤) يجب أن يُنهي بـ TOTAL: 1540/1540 — ALL GREEN ✓
```
لتشغيل الحزمة على ملفٍّ آخر: `SRC_HTML=index.source.html node run_all_tests.mjs`

## CI/CD
كل دفع إلى `main`: اختبارات التطبيق (١٬٥٤٠) + اختبارات القواعد بالمحاكي ← وعند الخضرة: نشر تلقائي إلى GitHub Pages.
